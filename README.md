...
- на `/login`, если оператор еще не вошел
- на `/dashboard`, если пароль уже введен

### `GET /login`

Открывает страницу входа в веб-панель.
...
Очищает cookie-сессию оператора.
...
- Операторский доступ к панели защищен паролем и cookie-сессией
